// Paste this whole file into: Supabase Dashboard -> Edge Functions ->
// Deploy a new function -> Via Editor -> name it "exchange-instagram-code".
// This is the login step -- connecting Instagram mints the session.
